...
public final class TronUtils {
    ...
    public static String encodeQuantity(BigInteger value) throws Exception{
        if (value.signum() != -1) {
    ...
    public static BigInteger decodeQuantity(String value) throws Exception{
        if (!isValidHexQuantity(value)) {
            throw new Exception("Value must be in format 0x[1-9]+[0-9]* or 0x0");
        } else {
            try {
                return new BigInteger(value.substring(2), 16);
            } catch (NumberFormatException var2) {
                throw new Exception("Negative ", var2);
            }
        }
    }
    ...
    public static void main(String args[]){
        System.out.print(toBigInt("00000000000000000000000000000000000000000000000000000004a8364c80"));
    }
}
